    ...
    const skillCategories = {
        ...
        Backend: {
            ...
            skills: [
                ...
                { name: 'REST APIs', level: 85, color: 'from-blue-400 to-blue-600' },
        ...
        <section id="skills" className="py-20 px-4 bg-gray-800/30">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {skillCategories[activeCategory].skills.map((skill, index) => (
                            <div
                                key={skill.name}
                                className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-blue-500/50 transition-all duration-300"
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-16">
                    <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 p-8 rounded-lg border border-blue-500/20">
