  ...
  Outside of coding, I’m an active learner who enjoys exploring emerging technologies, contributing to open-source projects, and sharing my knowledge through mentoring and technical writing. I believe in continuous improvement, collaboration, and the power of technology to solve real-world problems.
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <a
                ...
                className="flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-amber-500 rounded-lg hover:from-cyan-600 hover:to-amber-600 transition-all duration-300 transform hover:scale-105"
              >
              ...
              <a
                href="/cv/cvdta.pdf"
                download="Hammouda_Oussama_Data_CV.pdf"
                className="flex items-center px-6 py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-all duration-300"
              >
                <Download size={20} className="mr-2" />
                CV Data Analyst
              </a>
